    ...
    <div class="row">
      <div class="col-md-2">
        <div class="card">
          ...
          <div class="card-body">
            {{-- <a href="{{ route('types.index') }}" class="nav-link"><i class="fas fa-sort-amount-up-alt mr-2"></i> {{ trans('t.user.products.type') }}</a>
            ...
            <a href="{{ route('product.index') }}" class="nav-link"><i class="fas fa-box mr-2"></i>
