    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card card-primary">
          ...
          <form class="form-horizontal form-submit" method="POST" action="{{ route('user.update',$user->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" name="email" value="{{ $user->email }}" id="inputNombres" placeholder="Ingrese email" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" autocomplete="off" name="last_name" value="{{ $user->last_name }}" id="inputNombres" placeholder="Ingrese apellido" required>
