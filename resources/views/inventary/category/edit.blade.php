    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card card-primary">
          ...
          <form class="form-horizontal form-submit" method="POST" action="{{ route('category.update', $category->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="input-group col-sm-9">
                  <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" autocomplete="new-name" name="name" value="{{ $category->name }}" id="inputNombres" placeholder="Nombre" required>
