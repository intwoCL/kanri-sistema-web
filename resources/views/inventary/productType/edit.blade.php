          ...
          <form class="form-horizontal" method="POST" action="{{ route('types.update', $type->id) }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" autocomplete="off" name="name" value="{{ $type->name }}" id="inputNombres" placeholder="Ingrese nombre tipo producto" required>
