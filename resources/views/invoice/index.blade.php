...
@component('components.button._back')
  ...
  @slot('color', 'dark')
  @slot('body', "Listado de boleta/factura")
@endcomponent
    ...
    <div class="col-md-10">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Lista de boletas/facturas</h3>
          <a href="{{ route('invoice.create') }}" class="btn btn-primary float-right btn-sm">Nuevo</a>
        </div>
